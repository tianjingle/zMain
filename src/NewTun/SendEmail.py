...
class SendEmail:
    ...
    def sendYouCanBuy(self,currentPath):
        ...
        self.doSendStockInfoBeautiful(self.Zsm,currentPath,"\t001 回踩反弹（不要碰市值大的股票，反弹10%左右就立马撤。）")
        self.doSendStockInfoBeautiful(self.GSM,currentPath,"\t002 底部吸筹(不要碰市值小的股票)")
        self.doSendStockInfoBeautiful(self.SOUL,currentPath,"\t003 好望角(待定的策略~)")
